...
namespace TrinoClient.Naming
{
    ...
    public class TopicName : ServiceUnitId
    {
        ...
        public TopicName GetPartition(int index)
        {
            ...
            var partitionName = ToString() + PartitionedTopicSuffix + index;
